...
let osArch = os.arch();
let ownerRepo = 'variantdev/go-actions';
let toolName = 'go-actions';
if (!tempDirectory) {
    let baseLocation;
...
function getTool(version) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (!toolPath) {
            ...
            toolPath = yield acquireTool(version);
...
function getFileName(version) {
    ...
    const filename = util.format('download/v%s/actions_%s_%s_%s.%s', version, version, platform, arch, ext);
    return filename;
}
